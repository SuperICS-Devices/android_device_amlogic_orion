...
case $1 in 
    ...
    panel)
        fbset -fb /dev/graphics/fb0 -g 800 600 800 1200 32
        echo $1 > /sys/class/display/mode
        echo 0 0 800 600 0 0 18 18 > /sys/class/display/axis
    ;;
    
    *)
        echo "Error: Un-supported display mode $1"
        echo "       Default to panel"
        fbset -fb /dev/graphics/fb0 -g 800 600 800 1200 16 -rgba 5/11,6/5,5/0,0/0
        echo $1 > /sys/class/display/mode
        echo 0 0 800 600 0 0 18 18 > /sys/class/display/axis
esac
